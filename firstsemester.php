...
$OPIS = "Strona przedstawiająca przedmioty z jakimi zmagał się Piotr Masarczyk w 1 semestrze";
$STYL =<<<EOT
	   ...
	   function createA($class, $href, $text){
		...
		function createMainHeader($headerclass, $page, $target, $img, $imgclass, $imgalt, $divclass, $name){
		 ...
		 $s.= createDiv("holder", "<h1>Piotr Masarczyk</h1>
					...
					<h4>1 semestr Informatyka WPPT Politechnika Wrocławska</h4>".$v);		
		 $s.= "</header>\n";	
		 return $s;
		...
		echo createMainHeader("header", "new1.php", "_self", "photo.png", "picture", "Avatar", "holder", "1 semestr PWR");
		echo createAboutSubject("Analiza matematyczna 1", array("Konstrukcji zbioru liczb rzeczywistych", "Poprawnej definicji granicy ciągu", "Warunku Cauchy'ego dla ciągów"), array("Umiejętności obliczania całek", "Wzór Taylora"));
		echo createAboutSubject("Algebra z geom. analityczną", array("Definicja grupy i jej własności", "Definicja pierścienia i jego własności", "Podstawowy, rozszerzony algorytm Euklidesa", "Liczby zespolone"), array("Operacje na macierzach", "Zastosowanie pierścieni"));
		echo createAboutSubject("Wstęp do informatyki i programowania", array("Podstaw tworzenia algotymów", "Podstaw języka C", "Wyznaczania niezmiennika pętli"), array("Znajomość języka C"));
		echo createAboutSubject("Logika i struktury formalne", array("Rachunku zdań", "Metod dowodzenia twierdzeń", "Definicji relacji"), array("Wiedza na temat Wstęgi Mobiusa", "Wiedza na temat Butelki Kleina"));
