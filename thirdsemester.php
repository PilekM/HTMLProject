...
$OPIS = "Strona przedstawiająca przedmioty z jakimi zmagał się Piotr Masarczyk w 3 semestrze";
$STYL =<<<EOT
	   ...
	   function createA($class, $href, $text){
		...
		function createMainHeader($headerclass, $page, $target, $img, $imgclass, $imgalt, $divclass, $name){
		 ...
		 $s.= createDiv("holder", "<h1>Piotr Masarczyk</h1>
					...
					<h4>3 semestr Informatyka WPPT Politechnika Wrocławska</h4>".$v);		
		 $s.= "</header>\n";	
		 return $s;
		...
		echo createMainHeader("header", "new1.php", "_self", "photo.png", "picture", "Avatar", "holder", "3 semestr PWR");
		echo createAboutSubject("Architektura systemów i systemy operacyjne", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
		echo createAboutSubject("Technologia programowania", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
		echo createAboutSubject("Bazy danych", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
		echo createAboutSubject("Metody probabilistyczne i statystyka", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
