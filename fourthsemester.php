...
$OPIS = "Strona przedstawiająca przedmioty z jakimi zmagał się Piotr Masarczyk w 4 semestrze";
$STYL =<<<EOT
	   ...
	   function createA($class, $href, $text){
		...
		function createMainHeader($headerclass, $page, $target, $img, $imgclass, $imgalt, $divclass, $name){
		 ...
		 $s.= createDiv("holder", "<h1>Piotr Masarczyk</h1>
					...
					<h4>4 semestr Informatyka WPPT Politechnika Wrocławska</h4>".$v);		
		 $s.= "</header>\n";	
		 return $s;
		...
		echo createMainHeader("header", "new1.php", "_self", "photo.png", "picture", "Avatar", "holder", "4 semestr PWR");
		echo createAboutSubject("Algorytmy i struktury danych", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
		echo createAboutSubject("Nowoczesne technologie www", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
		echo createAboutSubject("Grafika komputerowa i wizualiz", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
		echo createAboutSubject("Wprowadzenie do teorii grafów", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
		echo createAboutSubject("Technologie sieciowe", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
		echo createAboutSubject("Negocjacje", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
		echo createAboutSubject("Przedsiębiorczość", array("Ładnie liczyć całki", "Obliczać granice", "Prawidłowe zastosowanie d'lopitala"), array("Fajna rzecz 1", "Fajna rzecz 2"));
